...
<body>
  ...
  <section class="bg-dark text-light p-5 text-center">
    <div class="container">
      <div class="row">
        ...
        <div class="col-sm">
          <h5>Trusted, bespoke and high quality wedding planning to make your dream day transform from an idea to reality</h5>
        </div>
      </div>
    </div>
  </section>
  ...
  <section>
    <div class="container-fluid bg-secondary text-light">
      ...
      <div id="container" class="row text-center text-dark flex justify-content-center">
